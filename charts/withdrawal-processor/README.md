...
| env[10].name | string | `"DOGEOS_WITHDRAWAL_COORDINATOR_POLL_INTERVAL_SECS"` |  |
| env[10].value | string | `"10"` |  |
| env[11].name | string | `"DOGEOS_WITHDRAWAL_DEBUG_SKIP_BROADCAST"` |  |
| env[11].value | string | `"false"` |  |
| env[12].name | string | `"DOGEOS_WITHDRAWAL_DOGECOIN_INDEXER__START_HEIGHT"` |  |
| env[12].value | string | `"4000000"` |  |
| env[13].name | string | `"DOGEOS_WITHDRAWAL_DOGECOIN_INDEXER__CONFIRMATIONS"` |  |
| env[13].value | string | `"1"` |  |
| env[14].name | string | `"DOGEOS_WITHDRAWAL_DOGECOIN_INDEXER__POLL_INTERVAL_MS"` |  |
| env[14].value | string | `"10000"` |  |
| env[15].name | string | `"DOGEOS_WITHDRAWAL_DOGEOS_INDEXER__RPC_URL"` |  |
| env[15].value | string | `"https://sepolia-rpc.scroll.io/"` |  |
| env[16].name | string | `"DOGEOS_WITHDRAWAL_DOGEOS_INDEXER__START_BLOCK"` |  |
| env[16].value | string | `"9416118"` |  |
| env[17].name | string | `"DOGEOS_WITHDRAWAL_DOGEOS_INDEXER__CONFIRMATIONS"` |  |
| env[17].value | string | `"10"` |  |
| env[18].name | string | `"DOGEOS_WITHDRAWAL_DOGEOS_INDEXER__POLL_INTERVAL_MS"` |  |
| env[18].value | string | `"5000"` |  |
| env[19].name | string | `"DOGEOS_WITHDRAWAL_DOGEOS_INDEXER__MESSENGER_ADDRESS"` |  |
| env[19].value | string | `"0xBa50f5340FB9F3Bd074bD638c9BE13eCB36E603d"` |  |
| env[1].name | string | `"DOGEOS_WITHDRAWAL_DATABASE_URL"` |  |
| env[1].value | string | `"sqlite:///app/data/withdrawal_processor.db"` |  |
| env[20].name | string | `"DOGEOS_WITHDRAWAL_DOGEOS_INDEXER__MESSAGE_QUEUE_ADDRESS"` |  |
| env[20].value | string | `"0x5300000000000000000000000000000000000000"` |  |
...
| env[6].value | string | `"2NFNonsBJC8ba8z9Xg7uZFboJ5mTrTzZMFQ"` |  |
| env[7].name | string | `"DOGEOS_WITHDRAWAL_BRIDGE_SCRIPT_HEX"` |  |
| env[7].value | string | `""` |  |
| env[8].name | string | `"DOGEOS_WITHDRAWAL_MAX_WITHDRAWAL_OUTPUTS_PER_TX"` |  |
| env[8].value | string | `"85"` |  |
| env[9].name | string | `"DOGEOS_WITHDRAWAL_FEE_RATE_SAT_PER_KVB"` |  |
