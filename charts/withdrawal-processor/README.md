...
| probes.livenessProbe.httpGet.path | string | `"/healthz/live"` |  |
...
| probes.readinessProbe.httpGet.path | string | `"/healthz/ready"` |  |
...
| probes.startupProbe.httpGet.path | string | `"/healthz/ready"` |  |
