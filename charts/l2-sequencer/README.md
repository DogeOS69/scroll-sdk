...
| env[11].name | string | `"VERBOSITY"` |  |
| env[11].value | string | `"3"` |  |
| env[1].name | string | `"L2GETH_LOCALS"` |  |
| env[1].value | string | `""` |  |
| env[2].name | string | `"L2GETH_MINER_GASLIMIT"` |  |
| env[2].value | string | `"10000000"` |  |
| env[3].name | string | `"L2GETH_RPC_HTTP_PORT"` |  |
| env[3].value | int | `8545` |  |
| env[4].name | string | `"L2GETH_RPC_WS_PORT"` |  |
| env[4].value | int | `8546` |  |
| env[5].name | string | `"L2GETH_P2P_PORT"` |  |
| env[5].value | string | `"30303"` |  |
