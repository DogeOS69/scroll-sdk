...
| grafana.additionalDataSources[0].jsonData.maxLines | int | `5000` |  |
...
| grafana.persistence.annotations."helm.sh/resource-policy" | string | `"keep"` |  |
...
| loki.loki.limits_config.retention_period | string | `"14d"` |  |
...
| loki.singleBinary.persistence.enableStatefulSetAutoDeletePVC | bool | `false` |  |
