...
![Version: 0.1.20-dogeos](https://img.shields.io/badge/Version-0.1.20--dogeos-informational?style=flat-square) ![AppVersion: v0.1.0](https://img.shields.io/badge/AppVersion-v0.1.0-informational?style=flat-square)
...
|------------|------|---------|
| oci://ghcr.io/dogeos69/scroll-sdk/helm | blockscout | 0.1.9-dogeos |
| oci://ghcr.io/dogeos69/scroll-sdk/helm | contracts | 0.1.14 |
| oci://ghcr.io/dogeos69/scroll-sdk/helm | gas-oracle | 0.1.4-dogeos |
| oci://ghcr.io/dogeos69/scroll-sdk/helm | l1-devnet | 0.1.5-dogeos |
...
| oci://ghcr.io/dogeos69/scroll-sdk/helm | preinstalls | 0.1.1-dogeos |
...
| file://../scroll-monitor | scroll-monitor | 0.1.21-dogeos |
...
| preinstalls.enabled | bool | `true` |  |
| preinstalls.image.repository | string | `"dogeos69/preinstalls"` |  |
| preinstalls.image.tag | string | `"v0.1.0"` |  |
| preinstalls.verify.blockscoutApiUrl | string | `"http://blockscout-blockscout-svc:80/api"` |  |
| preinstalls.verify.blockscoutHealthUrl | string | `"http://blockscout-blockscout-svc:80/api/v2/stats"` |  |
| preinstalls.verify.enabled | bool | `true` |  |
| preinstalls.verify.image.repository | string | `"dogeos69/preinstalls"` |  |
| preinstalls.verify.image.tag | string | `"v0.1.0"` |  |
| preinstalls.verify.scVerifierUrl | string | `"http://blockscout-sc-verifier:8080"` |  |
| preinstalls.waits.l2RpcEndpoint | string | `"http://l2-rpc:8545"` |  |
...
| scroll-monitor.scroll-monitor-agent.enabled | bool | `true` |  |
