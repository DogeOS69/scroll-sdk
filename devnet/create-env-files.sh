...
get_service_configmap_variables() {
    ...
    case "$service_name" in
        ...
        rollup-relayer)
            ...
            ;;
        preinstalls)
            echo "L2_RPC_ENDPOINT:L2_RPC_ENDPOINT DEPLOYER_PRIVATE_KEY:PRIV_KEY"
            ;;
        *)
...
services_configmap=("admin-system-backend" "balance-checker" "bridge-history-api" "bridge-history-fetcher" "blockscout" "chain-monitor" "contracts" "coordinator" "gas-oracle" "l1-devnet" "l1-explorer" "l2-bootnode" "l2-rpc" "l2-sequencer" "rollup-relayer" "preinstalls")
